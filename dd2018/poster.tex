...
\title{Spectral Stability of Double Pulse Solutions to the 5th order KdV Equation}
...
% first column
    \begin{column}{\onecolwid}
      \begin{alertblock}{Goal}
        ...
        double pulse solutions using a numerical approach.
        }
      \end{alertblock}
      ...
      \begin{block}{Homoclinic Orbits}
        \rmfamily{
          ...
          \vskip1ex
          \textbf{Theorem. }(\cite{Chug,Grov}) \emph{For $c>0$, a homoclinic orbit (single pulse) $u(x)$ exists which is smooth, even, and decays exponentially to 0 as $x \rightarrow \pm \infty.$}
        }
      \end{block}
...
% second column
    \begin{column}{\onecolwid}
      ...
      \rmfamily{
        ...
        \textbf{Theorem. }(\cite{Buf,Chug}) \emph{For $c>1/4$, a countably infinite family of double pulses exists, indexed by $n \in \mathbb{N}$. Double pulses resemble two copies of the single pulse separated by small-amplitude oscillatory tails. Distance between peaks is of order $n \pi / \beta.$ 
        }  
      }
      \end{block}
        ...
        \rmfamily{
          \begin{itemize}
            ...
            \begin{itemize}
              ...
              \item Gradually increase $c$ until $c > 1/4$
            \end{itemize}
          ...
          \begin{figure}
          \begin{center}
            \includegraphics[width=0.5\textwidth]{images/singlepulsemagright.pdf}
            \includegraphics[width=0.5\textwidth]{images/doublepulses.eps}
            \caption{Tail oscillations of single pulse (left). Double pulses 2(2), 2(3), 2(4), and 2(5), $c = 10$ (right).}
      ...
      \begin{block}{Eigenvalues of Double Pulses}
        \rmfamily{
            \begin{itemize}
              ...
              \item Additional eigenvalues near 0 from pulse interaction \cite{Sand} 
              \item Hamiltonian symmetry: if $\lambda$ is an eigenvalue, so are $-\lambda$, $\bar{\lambda}$, and $-\bar{\lambda}$
            \end{itemize}
...
% third column
    \begin{column}{\onecolwid}
      \begin{block}{Eigenvalue Computation}
        \rmfamily{
          ...
          \begin{center}
            ...
            \caption{Eigenvalues of linearization about double pulse 2(2) (left) and 2(3) (right), $c=10.$}
        ...
        \rmfamily{
          \begin{itemize}
            \item To find eigenvalues, use exponentially weighted space to move essential spectrum to the left
              \begin{figure}
              \begin{center}
              \includegraphics[width=0.5\textwidth]{images/stableweighted1.eps}
              \includegraphics[width=0.5\textwidth]{images/stableweighted2.eps}
              \caption{Eigenvalues of linearization about double pulse 2(3) in weighted space, $c=10$. Zoom near origin on right.}
              \label{fig:numericaleig2}
              \end{center}
              \end{figure}
            \item Double pulse 2(3), $c = 10$, has pair of eigenvalues
            \[
            \lambda = 2.0829 \times 10^{-11} \pm 0.0691i
            \]
          \item Krein signatures
            \begin{itemize}
              \item Interaction eigenvalues: negative
              \item Essential spectrum: positive
            \end{itemize}
          \item As domain size is increased, interaction eigenvalue collides with essential spectrum eigenvalue, but does not move off imaginary axis after collision
              \begin{figure}
              \begin{center}
              \includegraphics[width=0.7\textwidth]{images/kreincollision.eps}
              \caption{Plot of essential spectrum and interaction eigenvalues versus domain length showing collision of eigenvalues.}
              \label{fig:krein}
              \end{center}
              \end{figure}
        \end{itemize}
